...
public class SudokuGameChecker {
    /*******************************************************************************
     * Constant.
     *******************************************************************************/
    private static final String TAG = SudokuGameChecker.class.getSimpleName();
    /*******************************************************************************
     * Variable.
     *******************************************************************************/
    private static SudokuGameChecker mInstance;
     ...
     * @return
     */
    public static SudokuGameChecker getInstance() {
        if (mInstance == null) {
            mInstance = new SudokuGameChecker();
        }
